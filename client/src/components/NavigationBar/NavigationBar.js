...
const NavigationBar = () => {
	...
	const navbarMeun = () => {
		if (user.role === "user") {
			...
			return <SignInBtn onClick={activeModal} setUser={setUser}>로그인</SignInBtn>
		}
	}
	...
	return isLoading ? (
		...
		<>
				...
				{navbarMeun()}
				{showModal? <SignIn setUser={setUser} showModal={showModal} setShowModal={setShowModal} setUser={setUser}></SignIn>:null}
		</>	
	)
}
